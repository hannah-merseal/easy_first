...
#new tempo class plot where facet is n-gram PLUS lick/line
ngram_tempoclass_plot_ll <- function(data = wjd_inphrase_ll, 
                                  min_N = 3, 
                                  min_freq = 1, 
                                  max_pos = 30, 
                                  fix_scale = TRUE,
...
#tempo class plot where facet is new tempo class, n-gram = 4, WITH lick/line
tempoclass_plot_ll <- function(data = wjd_inphrase_ll, 
                            min_N = 3, 
                            min_freq = 1, 
                            max_pos = 30, 
                            fix_scale = TRUE,
